...
import fr.isen.melvingachet.androidsmartdevice.databinding.ActivityScanBinding
...
class ScanActivity : AppCompatActivity(){
    ...
    private fun togglePlayPauseAction(){
        ...
        if(mScanning){
            binding.scanTitle.text= getString(R.string.ble_scan_title_pause)
            binding.scanButton.setImageResource(R.drawable.pause_foreground  )
            binding.progressBar.isIndeterminate=true

        } else {
            binding.scanTitle.text= getString(R.string.ble_scan_title_play)
            binding.scanButton.setImageResource(R.drawable.play_foreground)
